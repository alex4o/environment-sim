...
public class GenderlessBreedSystem extends EntitySystem {
	...
	Field field;
	Engine engine;
	public GenderlessBreedSystem(Engine engine) {
		this.field = Field.getInstance();
		this.engine = engine;
	}

	public void addedToEngine(Engine engine) {
		entities = engine.getEntitiesFor(Family.all(Age.class, Life.class, Location.class, Breed.class).exclude(Gender.class).get());
	}
